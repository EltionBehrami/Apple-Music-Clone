import { playSong, pauseSong, setQueue, setCurrentSong, nextSong, previousSong, shuffleQueue, unshuffleQueue } from "../../../store/playbar";
import "./Controls.css"
...
const Controls = ( { audioRef, currentSong }) => {
    ...
    return (
        <div className="controls-container"> 
            <svg onClick={() => shuffle()} id="shuffle" width="32" height="25" viewBox="0 0 32 28" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg onClick={() => unshuffle()} className="order" width="32" height="25" viewBox="0 0 32 28" xmlns="http://www.w3.org/2000/svg">
