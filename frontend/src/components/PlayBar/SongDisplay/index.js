...
const SongDisplay = ( {progressBarRef, audioRef, progress, duration, setDuration}) => {
    ...
    return (
        ...
        <div className="songdisplay-container">
            ...
            <img id="song-album-display" src="https://is1-ssl.mzstatic.com/image/thumb/Music116/v4/67/f8/0c/67f80cef-4d4e-4792-1c69-c1d614065005/197189165450.jpg/296x296bf.webp"></img>
            </div>
